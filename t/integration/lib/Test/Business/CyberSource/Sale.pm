package Test::Business::CyberSource::Sale;
...
sub attempt_sale {
    ...
    my $sale;
    lives_ok {
        $sale = Business::CyberSource::Request::Sale->new({
    ...
    } "Lives Through Sale Creation";

    my $response;
    lives_ok {
        $response = $args{client}->submit($sale);
    } "Lives through sale request";
    ...
    note("Sale Request ID: " . $response->request_id);
